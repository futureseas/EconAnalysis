...
apollo_beta=apollo_readBeta(apollo_beta,apollo_fixed,"NL_participation_model_c6_for_predictions",overwriteFixed=FALSE)
...
# ################################################################# #
 ...
 model = apollo_estimate(apollo_beta, apollo_fixed,
                         ...
                         ,
                         estimate_settings=list(constraints=c("lambda_part < 1 + 1e-3",
                                                              "lambda_part - lambda_nanc > 1e-3",
                                                              "lambda_part - lambda_psdn > 1e-3",
                                                              "lambda_nanc > 0",
                                                              "lambda_psdn > 0"))
                         )
