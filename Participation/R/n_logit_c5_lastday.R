...
### Set core controls
apollo_control = list(
  modelName       = "NL_participation_model_c5_lastday",
...
long_data <- readRDS(paste0(google_dir, "Data/Anonymised data/part_model_c5.rds")) %>%
  dplyr::select("fished_haul_anon", "fished_vessel_anon", "selection", "fished",
                ...
                "psdnclosure", "msqdclosure", "waclosure", "dcrbclosurewad", "dummy_last_day",
...
database <- long_data %>%
  pivot_wider(
    ...
    values_from = c(fished, mean_avail, mean_price_3, wind_max_220_mh, dist_to_cog, 
                    dist_port_to_catch_area_zero, dummy_last_day, dcrbclosurewad, waclosure, 
                    unem_rate, d_d, d_cd)) %>%
...
df_selected <- database %>%
  dplyr::select(starts_with("waclosure_"))
summary(df_selected)
# 
# df_selected <- database %>%
...
apollo_beta=apollo_readBeta(apollo_beta,apollo_fixed,"NL_participation_model_c5_lastday_OLD1",overwriteFixed=FALSE)
...
# 
  ...
  V = list()
  V[["mna_msqd"]]         = asc_mna_msqd + B_mean_price_part * mean_price_3_mna_msqd + B_mean_avail * mean_avail_mna_msqd + B_wind_max_220_mh * wind_max_220_mh_mna_msqd + B_dist_port_to_catch_area_zero * dist_port_to_catch_area_zero_mna_msqd + B_dummy_last_day * dummy_last_day_mna_msqd + B_dist_to_cog * dist_to_cog_mna_msqd + B_unem_rate * unem_rate_ca + c_msqd * msqdclosure             + B_d_d * d_d_mna_msqd + B_d_cd * d_cd_mna_msqd + w_msqd * weekend                            
  ...
  V[["laa_psdn"]]         = asc_laa_psdn + B_mean_price_part * mean_price_3_laa_psdn + B_mean_avail * mean_avail_laa_psdn + B_wind_max_220_mh * wind_max_220_mh_laa_psdn + B_dist_port_to_catch_area_zero * dist_port_to_catch_area_zero_laa_psdn + B_dummy_last_day * dummy_last_day_laa_psdn + B_dist_to_cog * dist_to_cog_laa_psdn + B_unem_rate * unem_rate_ca + c_psdn * psdnclosure             + B_d_d * d_d_laa_psdn + B_d_cd * d_cd_laa_psdn + w_psdn * weekend     
  V[["clo_psdn"]]         = asc_clo_psdn + B_mean_price_part * mean_price_3_clo_psdn + B_mean_avail * mean_avail_clo_psdn + B_wind_max_220_mh * wind_max_220_mh_clo_psdn + B_dist_port_to_catch_area_zero * dist_port_to_catch_area_zero_clo_psdn + B_dummy_last_day * dummy_last_day_clo_psdn + B_dist_to_cog * dist_to_cog_clo_psdn + B_unem_rate * unem_rate_or + c_psdn * psdnclosure             + B_d_d * d_d_clo_psdn + B_d_cd * d_cd_clo_psdn + w_psdn * weekend                             
  V[["cwa_psdn"]]         = asc_cwa_psdn + B_mean_price_part * mean_price_3_cwa_psdn + B_mean_avail * mean_avail_cwa_psdn + B_wind_max_220_mh * wind_max_220_mh_cwa_psdn + B_dist_port_to_catch_area_zero * dist_port_to_catch_area_zero_cwa_psdn + B_dummy_last_day * dummy_last_day_cwa_psdn + B_dist_to_cog * dist_to_cog_cwa_psdn + B_unem_rate * unem_rate_wa + c_psdn * psdnclosure             + B_d_d * d_d_cwa_psdn + B_d_cd * d_cd_cwa_psdn + w_psdn * weekend + c_wa * waclosure_cwa_psdn                             
  V[["clw_psdn"]]         = asc_clw_psdn + B_mean_price_part * mean_price_3_clw_psdn + B_mean_avail * mean_avail_clw_psdn + B_wind_max_220_mh * wind_max_220_mh_clw_psdn + B_dist_port_to_catch_area_zero * dist_port_to_catch_area_zero_clw_psdn + B_dummy_last_day * dummy_last_day_clw_psdn + B_dist_to_cog * dist_to_cog_clw_psdn + B_unem_rate * unem_rate_wa + c_psdn * psdnclosure             + B_d_d * d_d_clw_psdn + B_d_cd * d_cd_clw_psdn + w_psdn * weekend + c_wa * waclosure_clw_psdn                             
  V[["sba_cmck"]]         = asc_sba_cmck + B_mean_price_part * mean_price_3_sba_cmck + B_mean_avail * mean_avail_sba_cmck + B_wind_max_220_mh * wind_max_220_mh_sba_cmck + B_dist_port_to_catch_area_zero * dist_port_to_catch_area_zero_sba_cmck + B_dummy_last_day * dummy_last_day_sba_cmck + B_dist_to_cog * dist_to_cog_sba_cmck + B_unem_rate * unem_rate_ca                                    + B_d_d * d_d_sba_cmck + B_d_cd * d_cd_sba_cmck + w_cmck * weekend                             
  V[["laa_cmck"]]         = asc_laa_cmck + B_mean_price_part * mean_price_3_laa_cmck + B_mean_avail * mean_avail_laa_cmck + B_wind_max_220_mh * wind_max_220_mh_laa_cmck + B_dist_port_to_catch_area_zero * dist_port_to_catch_area_zero_laa_cmck + B_dummy_last_day * dummy_last_day_laa_cmck + B_dist_to_cog * dist_to_cog_laa_cmck + B_unem_rate * unem_rate_ca                                    + B_d_d * d_d_laa_cmck + B_d_cd * d_cd_laa_cmck + w_cmck * weekend                             
  V[["laa_nanc"]]         = asc_laa_nanc + B_mean_price_part * mean_price_3_laa_nanc + B_mean_avail * mean_avail_laa_nanc + B_wind_max_220_mh * wind_max_220_mh_laa_nanc + B_dist_port_to_catch_area_zero * dist_port_to_catch_area_zero_laa_nanc + B_dummy_last_day * dummy_last_day_laa_nanc + B_dist_to_cog * dist_to_cog_laa_nanc + B_unem_rate * unem_rate_ca                                    + B_d_d * d_d_laa_nanc + B_d_cd * d_cd_laa_nanc + w_nanc * weekend                             
