...
apollo_beta=c(asc_sfa_nanc                   = -500,
              asc_laa_nanc                   = -500,
              asc_laa_cmck                   = -500,
              asc_laa_msqd                   = -500,
              asc_laa_ytna                   = -500,
