...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[["laa_ytna"]]         = asc_laa_ytna + w_tuna * weekend                        + B_mean_avail * mean_avail_laa_ytna + B_mean_price * mean_price_laa_ytna + B_wind_max_220_mh * wind_max_220_mh_laa_ytna + B_d_d * d_d_laa_ytna + B_dist_port_to_catch_area_zero * dist_port_to_catch_area_zero_laa_ytna + B_dummy_prev_days * dummy_prev_days_laa_ytna + B_dummy_prev_year_days * dummy_prev_year_days_laa_ytna + B_unem_rate_part * unem_rate + B_dist_to_cog * dist_to_cog_laa_ytna  
  ...
  V[["no_participation"]] = asc_no_participation + w_nopart * weekend + B_unem_rate_nopart * unem_rate
    ...
    # B_d_pd * d_pd_laa_msqd +
    # B_d_pd * d_pd_laa_ytna + B_d_cd * d_cd_laa_ytna + B_d_pcd * d_cd_laa_ytna
    # B_d_pd * d_pd_mna_msqd +                                                   
    # B_d_pd * d_pd_sba_msqd +                                                   
    # B_d_pd * d_pd_laa_btna + B_d_pcd * d_cd_laa_btna                         
    # B_d_pd * d_pd_sfa_msqd +
    # B_d_pd * d_pd_mna_psdn +
    # 
    # B_d_pd * d_pd_mra_msqd +
    # B_d_pd * d_pd_laa_psdn +
