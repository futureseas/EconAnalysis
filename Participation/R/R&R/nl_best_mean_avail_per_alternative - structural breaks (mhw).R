...
add_mhw <- function(db, date_var="set_date", years=2014:2016, out="mhw1416"){
...
apollo_beta_c4 <- c(
  ...
  B_mhw_mean_avail_nanc              =   0.930481,
  B_mhw_mean_avail_cmck              =   2.047942,
  B_mhw_mean_avail_msqd              =   3.071296,
  B_mhw_mean_avail_ytna              =   0.636432,
  B_mhw_mean_avail_btna              =   1.026160,
  B_mhw_mean_avail_psdn              =   1.943770,
  B_mhw_mean_price                   =  -0.090515,
  B_mhw_wind_max_220_mh              =   0.022894,
  B_mhw_dist_to_cog                  =  -0.001193,
  B_mhw_dist_port_to_catch_area_zero =  -0.014792,
  B_d_d                              =  -2.263051,
  B_d_cd                             =  -2.575678,
  B_d_c                              =  -1.249123,
...
apollo_beta_c5 = c(
  ...
  B_mhw_mean_avail_msqd              =    3.328742,
  B_mhw_mean_avail_psdn              =   -2.640318,
  B_mhw_mean_avail_cmck              =    2.477476,
  B_mhw_mean_avail_nanc              =   37.343553,
  B_mhw_mean_avail_albc              =    6.745862,
  B_mhw_mean_avail_dcrb              =    2.885049,
  B_mhw_wind_max_220_mh              =    0.015507,
  B_mhw_mean_price_part              =   -0.937504,
  B_mhw_mean_price_crab              =   -0.251601,
  B_mhw_dist_to_cog                  =  1.8199e-04,
  B_mhw_dist_port_to_catch_area_zero =   -0.004436,
...
apollo_beta_c6=c(
  ...
  B_mhw_mean_avail_psdn               = -2.364636,
  B_mhw_mean_avail_nanc               = -0.173314,
  B_mhw_mean_avail_othr               = -0.976751,
  B_mhw_mean_avail_cmck               =  1.235675,
  B_mhw_wind_max_220_mh               =  0.025217,
  B_mhw_dist_to_cog                   =  0.002394,
  B_mhw_dist_port_to_catch_area_zero  =  0.003839,
  B_mhw_mean_price_part               = -0.411477,
  B_mhw_mean_price_othr               = -0.016571,
...
apollo_beta_c7 = c(
  ...
  B_mhw_mean_avail_mckl              =    7.887799,
  B_mhw_mean_avail_msqd              =    1.409685,
  B_mhw_mean_avail_psdn              =    0.447252,
  B_mhw_mean_avail_nanc              =    0.754018,
  B_mhw_mean_price                   =    0.910516,
  B_mhw_wind_max_220_mh              =    0.002014,
  B_mhw_dist_to_cog                  = -8.7820e-04,
  B_mhw_dist_port_to_catch_area_zero =   -0.019983,
