...
### Set core controls
apollo_control = list(
  modelName       = "NL_participation_model_c7_30days",
...
database <- long_data %>%
  pivot_wider(
    ...
    values_from = c(fished, mean_avail, mean_price, wind_max_220_mh, dist_to_cog, 
                    ...
                    dcrbclosurewad, waclosure, unem_rate, d_d, d_pd)) %>%
...
apollo_beta=c(B_mean_avail                   = 0.31,
              B_mean_price                   = 0.2,
              B_wind_max_220_mh              = -0.04,
              B_dist_to_cog                  = -0.002,
              B_dist_port_to_catch_area_zero = -0.005,
              B_dummy_prev_days              = 2.8,
              B_dummy_prev_year_days         = 0.1,
              B_unem_rate_part               = 0.1,
              B_d_d                          = -0.3,
              B_d_pd                         = -0.1,
              w_cmck                         = -1, 
              w_msqd                         = -1,
...
# apollo_beta=apollo_readBeta(apollo_beta,apollo_fixed,"NL_participation_model_c7_30days",overwriteFixed=FALSE)
