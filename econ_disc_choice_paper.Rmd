...
<!-- DS about distances: in principle could be endogenous although i would not mention that here! endogenous since location site is a choice variable and onnce a location decisionn is made, then distance is made. note that the discrete choice literature uusing random utiolity models specifies distance as ann exogenous regressor. -->

<!--  handling vessel participation -- decisions such as: fish or not fish; switch target species; switch ports.?
See Birkenbach et al. MRE (Norwegian paper, discrete choice modeling -->

<!-- Beth -- logbook data and other data allowed her to bin them into vessels that are more traditional vs exploratory.  Metier analysis will highlight some of these . Explorers have high year-to-year variance, but high long term means.  Multivariate stats on long-time-scale logbook data can identify these fishing or business strategies.  -->
