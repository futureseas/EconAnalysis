...
of utility." (Revelt and Train, 1997)
    + Account for correlation in unobserved utility between repeated choices (Revelt and Train). The estimations is efficient. 
...
+ Choices:
  ...
  + Number of choices can vary between vessels, as well as the number of periods or choice situtations (Revelt and Train, 1997).
  +
