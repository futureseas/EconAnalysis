...
(g1 + g2) / (g3 + g4)
rm(g1, g2, g3, g4, df, landing.nvessels.year.sel)
...
ggplot(df) + 
  ...
  scale_y_continuous(name = "Number of vessels", 
                     sec.axis = sec_axis(~./coeff, name = "Percetage of vessel harvesting squid" )) +
...
ggplot(df) + 
  ...
  geom_line(mapping = aes(x = LANDING_YEAR, y = n_vessel_psdns,
...
rm(PacFIN.Gear.PSDN, PacFIN.Gear.MSQD, PacFIN.Gear.PHRG, PacFIN.Gear.NANC)
...
PacFIN.month.desc <- PacFIN.month.desc %>%
