...
est_data_psnd <- est_data %>%
  dplyr::select(port_num, Port, PSDN_SDM_60, MSQD_SDM_90, NANC_SDM_90, PSDN_Landings, Landing_year, ACL_PSDN) %>%
...
```{r MSQD_effect_total_nanc, eval=FALSE, fig.cap=, message=FALSE, warning=FALSE, include=FALSE}
plot(conditional_effects(fit_qMSQD, "NANC_SDM_90", surface=TRUE), ask = FALSE)
```  
