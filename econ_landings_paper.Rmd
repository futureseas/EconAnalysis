...
### Compare models 
```{r compare_model, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, results='asis'}
fit_qPSDN_gamma <- add_criterion(fit_qPSDN_gamma, "loo")
fit_qPSDN_lognormal <- add_criterion(fit_qPSDN_gamma, "waic")
...
```{r y_rep_gamma_close, eval=FALSE, fig.cap=, message=FALSE, warning=FALSE, include=FALSE}
...
```{r ACL_effect, echo=FALSE, fig.cap=, message=FALSE, warning=FALSE}
...
str(est_data_msqd_all$dACL_MSQD)
