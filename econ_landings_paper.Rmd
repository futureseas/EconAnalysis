...
```{r avg_land_rev_price, echo=FALSE, fig.cap="Average annual landings, prices and revenues by species (1981-2020).\\label{fig:avg_lan_rev}"}
## Landings chart
