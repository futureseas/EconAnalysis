...
fit_qPSDN <- brm(bf(PSDN_Landings ~ PSDN_SDM_60 + MSQD_SPAWN_SDM_90 + (1 | group)  + (1 | port_ID),
                               hu ~ (1 | group) + (1 | port_ID)),
                    data = dataset_psdn, family = hurdle_gamma(), chains = 4, cores = 4,
