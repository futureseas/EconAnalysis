...
Additionally, we also estimate a multiplicities participation model based on @richerson2017 who study the effect of salmon closure on fishers participation, expanding their analysis to the CPS fishery. For this, we develop a Random Utility Model to model monthly vessel participation in targeting a specific species in the CPS fishery. 
