...
<!-- 
There is also a discussion about endogeneity when we use catch as explanatory variable. We are using SDM to get an idea of expected revenue, which can allow to deal with the problem. Also allos us to isolate the effect of abundance from the choice constant. 
-->
