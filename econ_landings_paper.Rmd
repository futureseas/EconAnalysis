...
```{r cluster_analysis_TIM, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
...
setwd("C:/Users/Tim/Desktop/PacFin_Data")


###Load in the data
Tickets1<-fread("FutureSeasIII_2000_2009.csv")
Tickets2<-fread("FutureSeasIII_2010_2020.csv")
