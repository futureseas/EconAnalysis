...
round( xtabs(LANDED_WEIGHT_LBS.sum ~ PACFIN_SPECIES_CODE + PACFIN_GEAR_CODE, data = PacFIN.CPS )/2204.6, 0 )
...
```{r change_names, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
names(PacFIN_yearlya_port)[names(PacFIN_yearlya_port) == "LANDING_YEAR"              ] <- "Year"
names(PacFIN_yearlya_port)[names(PacFIN_yearlya_port) == "PACFIN_SPECIES_CODE"       ] <- "Species_code"
names(PacFIN_yearlya_port)[names(PacFIN_yearlya_port) == "PACFIN_SPECIES_COMMON_NAME"] <- "Species_name"
names(PacFIN_yearlya_port)[names(PacFIN_yearlya_port) == "LANDED_WEIGHT_MTONS"       ] <- "Landings"
names(PacFIN_yearlya_port)[names(PacFIN_yearlya_port) == "EXVESSEL_REVENUE"          ] <- "Revenue"
names(PacFIN_yearlya_port)[names(PacFIN_yearlya_port) == "LANDED_WEIGHT_PPP"         ] <- "Price"
names(PacFIN_yearlya_port)[names(PacFIN_yearlya_port) == "AGENCY_CODE"               ] <- "State"
names(PacFIN_yearlya_port)[names(PacFIN_yearlya_port) == "MANAGEMENT_GROUP_CODE"     ] <- "Management_group"
