...
### Compare models 
```{r compare_model, message=FALSE, warning=FALSE, results='asis'}

loo(fit_qPSDN_gamma, fit_qPSDN_gamma_close)

# fit_qPSDN_gamma <- add_criterion(fit_qPSDN_gamma, "loo")
# fit_qPSDN_gamma <- add_criterion(fit_qPSDN_gamma, "waic")
# fit_qPSDN_gamma_close <- add_criterion(fit_qPSDN_gamma_close, "loo")
# fit_qPSDN_gamma_close <- add_criterion(fit_qPSDN_gamma_close, "waic")
# 
# loo_compare(loo(fit_qPSDN_gamma), loo(fit_qPSDN_gamma_close)) %>%
#   as.data.frame() %>%
...
#   )
# 
# mw1 <- model_weights(fit_qPSDN_gamma, fit_qPSDN_gamma_close, weights = "loo")[rownames(comp)]
# 
# comp %>%
...
# 
# pp_gamm_c <- pp_check(fit_qPSDN_gamma_close) + ggtitle('Gamma distribution (close)') + theme(legend.position = "bottom")
# 
# pp_gamm_c / pp_gamm
```
...
```{r yrep_log, eval=FALSE, fig.cap=, message=FALSE, warning=FALSE, include=FALSE}
